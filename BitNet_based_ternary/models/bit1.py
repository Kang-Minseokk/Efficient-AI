...
class BitNetMLP(nn.Module):
    ...
    def __init__(self,
                 ...
                 depth: int = 4,
                 dropout: float = 0.1,
                 quant_type: str = 'binary'
                 ):
        super().__init__()
        assert quant_type in ['binary', 'ternary'], "quant_type must be 'binary' or 'ternary'"
        LinearLayer = BinaryLinear if quant_type == 'binary' else TernaryLinear
