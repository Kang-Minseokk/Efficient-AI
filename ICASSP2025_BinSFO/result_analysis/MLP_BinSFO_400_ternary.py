...
def main():
    log_path = "../result/MLP_BinSFO_400.out"
    ...
    plt.title("MLP BinSFO w Ternary Accuracy")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("MLP_BinSFO_400_ternary.png")
    print("그래프 저장 완료: MLP_BinSFO_400_ternary.png")
